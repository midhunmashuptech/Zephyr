              ...
              children: [
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: Lottie.asset("assets/lottie/makeYourTest.json"),
                  ),
                ),
                RichText(
                  text: const TextSpan(
                ...
                makeTestProvider.isOptionsLoading
                    ...
                    : Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              DropdownMenu(
                                ...
                                onSelected: (value) =>
                                    makeTestProvider.setQuestionCount(
                                  int.parse(value ?? "10"),
                                ),
                          ...
                          // Chapter
                          IgnorePointer(
                            ignoring: makeTestProvider.chapters.isEmpty,
                            child: DropdownMenu(
                              hintText: "Chapter",
                              ...
                              dropdownMenuEntries: List.generate(
                                ...
                                (index) => DropdownMenuEntry(
                                  ...
                                  label:
                                      makeTestProvider.chapters[index].title ??
                                          "Option Value",
                                ),
                              ),
                            ),
                          ...
                          CustomButton(
                              ...
                              onPressed: makeTestProvider
                                      .checkAllSelectedValues()
                                  ? () async {
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              AttendAiTestScreen(
                                            userid: userDetailsProvider
                                                .userDetails.id
                                                .toString(),
                                            questionsCount: (makeTestProvider
                                                        .selectedQuesCount ??
                                                    10)
                                                .toString(),
