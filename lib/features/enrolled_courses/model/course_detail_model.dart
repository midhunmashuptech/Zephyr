...
// 	Data({this.id, this.title, this.thumbnail, this.type, this.level, this.price, this.description, this.duration, this.startDate, this.endDate, this.categories, this.subjects, this.ratings, this.likes, this.likeCount, this.ratingCount, this.averageRating});
...
// 		if (json['likes'] != null) {
// 			likes = <Null>[];
// 			json['likes'].forEach((v) { likes!.add(new Null.fromJson(v)); });
// 		}
...
// 	Subjects({this.classId, this.class, this.subjectId, this.subject, this.chapters});
